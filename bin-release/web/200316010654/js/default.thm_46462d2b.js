window.skins=window.skins||{};
	...
	var gameSceneSkin$Skin1 = 	(function (_super) {
		...
		function gameSceneSkin$Skin1() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","left_hover_png")
					])
				,
				new eui.State ("disabled",
					[
	...
	var gameSceneSkin$Skin2 = 	(function (_super) {
		...
		function gameSceneSkin$Skin2() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","right_hover_png")
					])
				,
				new eui.State ("disabled",
					[
	...
	var gameSceneSkin$Skin3 = 	(function (_super) {
		...
		function gameSceneSkin$Skin3() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","attack_hover_png")
					])
				,
				new eui.State ("disabled",
					[
	...
	var gameSceneSkin$Skin4 = 	(function (_super) {
		...
		function gameSceneSkin$Skin4() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","carry_png")
					])
				,
				new eui.State ("disabled",
					[
	...
	var gameSceneSkin$Skin5 = 	(function (_super) {
		...
		function gameSceneSkin$Skin5() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","jump_hover_png")
					])
				,
				new eui.State ("disabled",
					[
	...
	function gameSceneSkin() {
		_super.call(this);
		this.skinParts = ["leftBtn","rightBtn","attackBtn","carryBtn","upBtn","timer","controlGroup"];
	...
	_proto.controlGroup_i = function () {
		...
		t.top = 0;
		t.zIndex = 1;
		t.elementsContent = [this.leftBtn_i(),this.rightBtn_i(),this.attackBtn_i(),this.carryBtn_i(),this.upBtn_i(),this.timer_i()];
		return t;
	};
	...
	function mainSceneSkin() {
		_super.call(this);
		this.skinParts = ["yun","image1","image2","image","image0","startBtn"];
	...
	function matchSceneSkin() {
		_super.call(this);
		this.skinParts = ["backBtn","testBtn"];
...
})(eui.Skin);generateEUI.paths['resource/scene/startScene.exml'] = window.startSceneSkin = (function (_super) {
	__extends(startSceneSkin, _super);
	function startSceneSkin() {
		_super.call(this);
		this.skinParts = ["joinBtn","randomBtn","userAvatar","userId","userName","logText","joinId","joinRoomBtn","joinRoom"];
		
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this._Rect1_i(),this.joinBtn_i(),this.randomBtn_i(),this.userAvatar_i(),this.userId_i(),this.userName_i(),this.logText_i(),this.joinRoom_i()];
	}
	...
	_proto.joinRoom_i = function () {
		...
		t.x = 133;
		t.y = 253;
		t.elementsContent = [this._Rect2_i(),this._Label1_i(),this.joinId_i(),this.joinRoomBtn_i()];
		return t;
	};
	_proto._Rect2_i = function () {
		var t = new eui.Rect();
		t.bottom = 0;
		t.fillColor = 0xfcb5db;
		t.left = 0;
		t.right = 0;
		t.top = 0;
		return t;
